...
//                self.textView.text = String(data: self.data, encoding: .utf8)
                self.switchablePokemonIDs.append(Int(String(data: self.data, encoding: .utf8) ?? "") ?? -1)
            }
...
//        dataToSend = textView.text.data(using: .utf8)!
        dataToSend = String(pokemonWillBeSent).data(using: .utf8)!
...
//            self.textView.text = stringFromData
            ...
            print("################ Suppose to be the textView Update")
        }
    }
}
